...
/** Diese Klasse enth�lt alle f�r die Implementierung eines Applets wichtigen Methoden
...
pufferung in der Methode update, sie h�rt auf Mausereignisse (mouseDown) und enth�lt
alle f�r den Ablauf des Spiels wichtigen Anweisungen */
...
public class Main extends Applet implements Runnable
{
    ...
    boolean isStoped = true;		// Zeigt an, ob das Spiel gestopt ist (true) oder l�uft (false)
    ...
    // Thread
    Thread th;						// Thread in dem das Spiel l�uft
    ...
    public void init ()
    {
        ...
        // Laden der Bilder und Audiodateien und einmaliges Abspielen, um l�ngere Ladezeiten w�hrend des Spiels zu vermeiden
    ...
    public boolean mouseDown (final Event e, final int x, final int y)
    {
        ...
        if (!this.isStoped)
        {
            ...
            if (this.redball.userHit (x, y))
            {
                ...
                // Ball zu Startwert zur�cksetzten
            ...
            {
                // Abspielen des normalen Schussger�usches
                this.shotnoise.play();
            }
    ...
    {
        // Wenn noch Leben �brig sind
        if (this.player.getLives() >= 0)
        {
            // Setzen der Farbe
            g.setColor (Color.yellow);

            // Punktestand und �brige Leben
        ...
        else if (this.player.getLives() < 0)
        {
            ...
            this.isStoped = true;	// Zur�cksetzen der isStoped Variablen, um wieder neu beginnen zu k�nnen
        }
    }
